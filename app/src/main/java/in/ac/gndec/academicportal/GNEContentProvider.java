...
public class GNEContentProvider extends ContentProvider {

    helper helper;
    SQLiteDatabase database;

    public GNEContentProvider() {
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        return database.query(uri.getLastPathSegment(),projection,selection,selectionArgs,sortOrder,null,null);
    }
